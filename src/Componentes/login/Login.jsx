...
const LoginForm = ({ onLogin }) => {
  ...
  const handleSignUpClick = () => {   // Función que muestra el formulario de registro
    setRightPanelActive(true);
  };

 
  const handleSignInClick = () => {    // Función que muestra el formulario de inicio de sesión
    setRightPanelActive(false);
  };

  
  const handleLoginSubmit = (e) => {  // Función que maneja el envío del formulario de inicio de sesión
    e.preventDefault();               // Evita el comportamiento predeterminado del formulario

    
    if (email === "prueba@gmail.com" && password === "contraseña123") {   // Simulación de autenticación. Valida si las credenciales son correctas
